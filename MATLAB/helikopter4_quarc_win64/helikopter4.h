 ...
 */
#ifndef RTW_HEADER_helikopter4_h_
#define RTW_HEADER_helikopter4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helikopter4_COMMON_INCLUDES_
# define helikopter4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopter4_COMMON_INCLUDES_ */

#include "helikopter4_types.h"
...
#define helikopter4_rtModel            RT_MODEL_helikopter4_T
...
#define rtB                            helikopter4_B
#define BlockIO                        B_helikopter4_T
#define rtX                            helikopter4_X
#define ContinuousStates               X_helikopter4_T
#define rtXdot                         helikopter4_XDot
#define StateDerivatives               XDot_helikopter4_T
#define tXdis                          helikopter4_XDis
#define StateDisabled                  XDis_helikopter4_T
#define rtP                            helikopter4_P
#define Parameters                     P_helikopter4_T
#define rtDWork                        helikopter4_DW
#define D_Work                         DW_helikopter4_T

/* Parameters (auto storage) */
struct P_helikopter4_T_ {
  ...
  real_T Sat_LowerSat;                 /* Expression: -5
                                        * Referenced by: '<S2>/Sat'
                                        */
  real_T elevation_Value;              /* Expression: 0.6
...
extern P_helikopter4_T helikopter4_P;

/* Block signals (auto storage) */
extern B_helikopter4_T helikopter4_B;

/* Continuous states (auto storage) */
extern X_helikopter4_T helikopter4_X;

/* Block states (auto storage) */
extern DW_helikopter4_T helikopter4_DW;

/* Model entry point functions */
extern void helikopter4_initialize(void);
extern void helikopter4_output(void);
extern void helikopter4_update(void);
extern void helikopter4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helikopter4_T *const helikopter4_M;
 ...
 *
 * '<Root>' : 'helikopter4'
 * '<S1>'   : 'helikopter4/Elevasjonskontroller'
 * '<S2>'   : 'helikopter4/Heli 3D'
 * '<S3>'   : 'helikopter4/LQR'
 * '<S4>'   : 'helikopter4/Pitch-kontroller'
 * '<S5>'   : 'helikopter4/V_d//V_s --> V_f//V_b'
 */
#endif                                 /* RTW_HEADER_helikopter4_h_ */
