...
%%%%%%%%%%% Physical constants
%%wights
m_w = 1.931;                        % Mass of the counterweight
m_h = 1.457;                        % Mass of helicopter
m_g = 0.045;                        % Effective mass of the helicopter
%%Distances
l_a = .66;                          % Distance from elevation axis to helicopter body
l_h = 0.18;                        % Distance from pitch axis to motor
%%Moments
...
%Voltage
V_f_eq=.63;%.625;%.595;                         % Voltage motor in front, Change the value so that it matches the current helicopter
V_b_eq=.615;%.707;                          % 0.85;%1.2; Voltage motor in back, Change the value so that it matches the current helicopter
