...
%%%%%%%%%%% Physical constants
%%wights
m_w = 1.923;%1.795;                        % Mass of the counterweight
m_h = 1.339;%1.420;                         % Mass of helicopter
m_g = 0.049;%0.012;                        % Effective mass of the helicopter
%%Distances
l_a = 0.66;%0.625;                         % Distance from elevation axis to helicopter body
l_h = 0.181;%0.177;                        % Distance from pitch axis to motor
%%Moments
...
%Voltage
V_f_eq=.625;%0.7                         % Voltage motor in front, Change the value so that it matches the current helicopter
