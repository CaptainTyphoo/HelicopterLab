...
%%%%%%%%%%% Physical constants
%%wights
m_w = 1.923;%1.802;                        % Mass of the counterweight
m_h = 1.332;%1.297;                         % Mass of helicopter
m_g = 0.042;%0.026;                        % Effective mass of the helicopter
%%Distances
l_a = 0.658;%0.64;                         % Distance from elevation axis to helicopter body
l_h = 0.180;%0.177;                        % Distance from pitch axis to motor
%%Moments
