...
%%%%%%%%%%% Physical constants
%%wights
m_w = 1.936;%1.795;                        % Mass of the counterweight
m_h = 1.296;%1.420;                         % Mass of helicopter
m_g = 0.042;%0.012;                        % Effective mass of the helicopter
%%Distances
l_a = 0.660;%0.625;                         % Distance from elevation axis to helicopter body
l_h = 0.182;%0.177;                        % Distance from pitch axis to motor
%%Moments
