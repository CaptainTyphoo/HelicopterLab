...
%%%%%%%%%%% Physical constants
%%wights
m_w = 1.935;                        % Mass of the counterweight
m_h = 1.374;                        % Mass of helicopter
m_g = 0.037;                        % Effective mass of the helicopter
%%Distances
l_a = .660;                          % Distance from elevation axis to helicopter body
l_h = 0.181;                        % Distance from pitch axis to motor
%%Moments
...
%Voltage
V_f_eq=.6;%.625;                         % Voltage motor in front, Change the value so that it matches the current helicopter
V_b_eq=.58; %.6                         % 0.85;%1.2; Voltage motor in back, Change the value so that it matches the current helicopter
